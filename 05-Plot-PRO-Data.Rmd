...
# Define the packages
packages <- c("tidyverse", "kableExtra", "ggtext", "RCurl", "plyr","scales","forcats",
              "ggplot2", "ggrepel", "cowplot", "lubridate", "readxl", "plotly","shiny",
              "gridExtra", "patchwork", "reshape2", "grid", "ggthemes", "ggcharts",
