...
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_semflow.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_pathlegend1.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_pathlegend2.png")
```

The following is a path diagram of all the types of variables and relationships 

```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_pathlegend3.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SME_fit1.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SME_fit2.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m1a.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m2.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m3a.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m3b.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m3c.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m4a.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m4b.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m4c.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m5a.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m5b.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_m6a.png")
```
...
```{r , echo=FALSE, fig.align="center", out.width = '75%'}
knitr::include_graphics("./02_Plots/Structural Equation Modeling/SEM_CFA_01.png")
```
