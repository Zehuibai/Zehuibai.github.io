...
* In a **normal distribution prior** with mean $\mu_0$ and variance $\sigma_0^2$, $\mu_0$ and $\sigma_0^2$ are hyperparameters.
* In a **beta distribution prior** with shape parameters $\alpha$ and $\beta$, these two values are the hyperparameters.
